...
void TriMesh::need_bsphere()
{
	...
	ifstream bsphere_if(dFName.getBsphereDN());
	if (bsphere_if.is_open())
	{
		cout<<"Reading bounding sphere.....";

		bsphere_if >> bsphere.center[0];
		bsphere_if >> bsphere.center[1];
		bsphere_if >> bsphere.center[2];
		bsphere_if >> bsphere.r;
		bsphere.valid = true; 
	...
	cout<<"Writing bounding sphere.....";
	ofstream bsphere_of(dFName.getBsphereDN());
	bsphere_of<<bsphere.center[0]<<" ";
	bsphere_of<<bsphere.center[1]<<" ";
	bsphere_of<<bsphere.center[2]<<" ";
	bsphere_of<<bsphere.r;
	bsphere_of.close();
	cout<<"Done!"<<endl;
